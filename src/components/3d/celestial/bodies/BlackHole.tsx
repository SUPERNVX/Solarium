...
export default function BlackHole() {
        ...
        return new THREE.ShaderMaterial({
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    fresnel = pow(fresnel, 2.0); vec3 glowColor = vec3(1.0, 0.4, 0.0);
    ...
    const diskMaterial = useMemo(() => {
        return new THREE.ShaderMaterial({
            uniforms: {
                ...
                uColorMid1: { value: new THREE.Color(0xffaa00) }, uColorMid2: { value: new THREE.Color(0xff4400) },
                uColorOuter: { value: new THREE.Color(0x331100) }, uNoiseScale: { value: 3.5 },
    ...
    return (
        <group ref={groupRef}>
            ...
            {/* Lensing Effect attached to this Black Hole */}
